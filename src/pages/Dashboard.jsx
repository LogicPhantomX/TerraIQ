...
useEffect(() => {
  ...
  if (type === "signup" || type === "email_change") {
    toast.success("Email confirmed! Welcome to TerraIQ+");
      ...
      {isNewUser && (
        <div className="bg-terra/10 dark:bg-terra/10 border border-terra/20 rounded-2xl p-5 mb-6 flex gap-4 items-start">
          ...
          <div className="flex-1">
            ...
            <p className="text-ink-500 dark:text-gray-400 text-sm mb-3">Your farm is set up. Start by scanning a crop or analysing your soil to see AI recommendations.</p>
