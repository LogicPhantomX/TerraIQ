      ...
      <div style={{ padding:"9px 14px",background:"linear-gradient(to bottom,rgba(0,0,0,0.95),transparent)",
        ...
        <div style={{ display:"flex",alignItems:"center",gap:7 }}>
          ...
          <div>
            ...
            <div style={{ color:`${PC}50`,fontSize:6,letterSpacing:2 }}>MULTI-ANGLE SCAN · WEED · CROP · TREE</div>
          </div>
        </div>
        <div style={{ display:"flex",gap:8,alignItems:"center" }}>
          ...
          {captures.length > 0 && (
            <span style={{ color:PC,fontSize:8,fontWeight:"bold" }}>{captures.length}/{ANGLE_GUIDES.length} CAPTURED</span>
          )}
        </div>
      </div>
